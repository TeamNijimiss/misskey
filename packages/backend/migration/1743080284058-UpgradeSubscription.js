export class UpgradeSubscription1743080284058 {
    async up(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "role" ADD "isForSubscriptions" boolean NOT NULL DEFAULT false`);
				await queryRunner.query(`ALTER TABLE "user" ALTER COLUMN "subscriptionPlanId" TYPE character varying(128) USING "subscriptionPlanId"::character varying(128)`);
				await queryRunner.query(`UPDATE "user" SET "subscriptionPlanId" = sp."stripePriceId" FROM subscription_plan sp WHERE "subscriptionPlanId" = sp.id`)
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "user" ALTER COLUMN "subscriptionPlanId" TYPE character varying(32) USING "subscriptionPlanId"::character varying(32)`);
