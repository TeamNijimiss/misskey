	...
	constructor(
		...
		super(meta, paramDef, async () => {
			...
			return {
				...
				hcaptchaSecretKey: metaService.getMaskString(),
				mcaptchaSecretKey: metaService.getMaskString(),
				recaptchaSecretKey: metaService.getMaskString(),
				turnstileSecretKey: metaService.getMaskString(),
				...
				smtpPass: metaService.getMaskString(),
				swPrivateKey: metaService.getMaskString(),
