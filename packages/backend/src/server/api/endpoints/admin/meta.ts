	...
	constructor(
		...
		super(meta, paramDef, async () => {
			...
			return {
				...
				hcaptchaSecretKey: mask,
				mcaptchaSecretKey: mask,
				recaptchaSecretKey: mask,
				turnstileSecretKey: mask,
